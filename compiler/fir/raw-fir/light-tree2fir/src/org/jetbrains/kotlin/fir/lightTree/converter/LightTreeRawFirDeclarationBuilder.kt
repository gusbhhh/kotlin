...
class LightTreeRawFirDeclarationBuilder(
    ...
    fun convertPropertyDeclaration(property: LighterASTNode, classWrapper: ClassWrapper? = null): FirDeclaration {
        ...
        val propertySymbol = if (isLocal) FirPropertySymbol(propertyName) else FirPropertySymbol(callableIdForName(propertyName))
        context.pushContainerSymbol(propertySymbol)
    ...
    private fun convertExplicitDelegation(
        ...
        var firExpression: FirExpression? = null
        val fieldName = NameUtils.delegateFieldName(delegateFieldsMap.size)
        val fieldSymbol = FirFieldSymbol(CallableId(context.currentClassId, fieldName))
//        context.pushContainerSymbol(fieldSymbol)
...
//        context.popContainerSymbol(fieldSymbol)
        return firTypeRef
    }
