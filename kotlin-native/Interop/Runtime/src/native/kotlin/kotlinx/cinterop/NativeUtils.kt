...
@ExperimentalForeignApi
public fun UByteArray.toCValues(): CValues<UByteVarOf<UByte>> = cValuesOf(*this)
@ExperimentalForeignApi
public fun UShortArray.toCValues(): CValues<UShortVarOf<UShort>> = cValuesOf(*this)
@ExperimentalForeignApi
public fun UIntArray.toCValues(): CValues<UIntVarOf<UInt>> = cValuesOf(*this)
@ExperimentalForeignApi
public fun ULongArray.toCValues(): CValues<ULongVarOf<ULong>> = cValuesOf(*this)
