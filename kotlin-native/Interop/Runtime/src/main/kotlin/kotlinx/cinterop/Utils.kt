 ...
 */
@ExperimentalForeignApi
public fun <T : CPointed> NativePlacement.allocArrayOfPointersTo(vararg elements: T?): CPointer<CPointerVarOf<CPointer<T>>> =
...
@ExperimentalForeignApi
public fun <T : CPointed> NativePlacement.allocPointerTo(): CPointerVarOf<CPointer<T>> = alloc<CPointerVar<T>>()
...
@ExperimentalForeignApi
public fun ByteArray.toCValues(): CValues<ByteVarOf<Byte>> = cValuesOf(*this)
@ExperimentalForeignApi
public fun ShortArray.toCValues(): CValues<ShortVarOf<Short>> = cValuesOf(*this)
@ExperimentalForeignApi
public fun IntArray.toCValues(): CValues<IntVarOf<Int>> = cValuesOf(*this)
@ExperimentalForeignApi
public fun LongArray.toCValues(): CValues<LongVarOf<Long>> = cValuesOf(*this)
@ExperimentalForeignApi
public fun FloatArray.toCValues(): CValues<FloatVarOf<Float>> = cValuesOf(*this)
@ExperimentalForeignApi
public fun DoubleArray.toCValues(): CValues<DoubleVarOf<Double>> = cValuesOf(*this)
@ExperimentalForeignApi
public fun <T : CPointed> Array<CPointer<T>?>.toCValues(): CValues<CPointerVarOf<CPointer<T>>> = cValuesOf(*this)
@ExperimentalForeignApi
public fun <T : CPointed> List<CPointer<T>?>.toCValues(): CValues<CPointerVarOf<CPointer<T>>> = this.toTypedArray().toCValues()
