...
object TestModuleStructureFactory {
    ...
    private fun stdlibAndSdkDependencies(
        ...
        return when {
            ...
            module.platform.isCommon() -> commonStdlibDependencies(project, testServices)
    ...
    private fun commonStdlibDependencies(project: Project, testServices: TestServices): List<KtBinaryModule> {
        return listOf(
        )
    }
